...
import "@openzeppelins/contracts-upgradeable/utils/ReentrancyGuardUpgradeable.sol";
import "@openzeppelins/contracts-upgradeable/utils/PausableUpgradeable.sol";
...
/**
 * @title KTTYStaking
 * @dev An upgradeable staking contract for KTTY token with multiple tiers and reward tokens
 */
contract KTTYStaking is 
    Initializable, 
    ...
    UUPSUpgradeable 
{
     ...
     */
    function initialize(address _kttyToken) external initializer {
